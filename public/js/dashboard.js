  ...
  $(function () {
    ...
    if ($('#dashboard-sales-chart').length) {
      var GraphBar = Morris.Bar({
        ...
        barColors: [successColor, infoColor, primaryColor, secondaryColor, warningColor, dangerColor, darkColor],
        barGap: 3,
        grid: false,
        barSizeRatio: 0.40,
        xkey: 'y',
        ...
        gridTextSize: 0,
        padding: 1,
        labels: ['Kecamatan', 'Jembatan', 'User', 'Jenis Infrastruktur', 'Sumber Dana', 'Jenis Jembatan', 'Beban Jalan']
      });
      $(window).on("resize", function () {
        GraphBar.redraw();
      });
