            ...
            <div class="col-12 d-flex align-items-center justify-content-between">
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb breadcrumb-custom">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><span>Data Kecamatan</span></li>
                      </ol>
                    </nav>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Nama Kecamatan</label>
                              <input type="text" class="form-control" id="recipient-name" value="Medan Labuhan">
                            </div>
                        </div>
                        <div class="modal-footer">
