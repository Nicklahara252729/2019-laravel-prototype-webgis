...
<div class="content-wrapper">
          <div class="row mb-4">
            <div class="col-12 d-flex align-items-center justify-content-between">
              <h4 class="page-title">Data Klasifikasi Fungsi Jembatan</h4>
            ...
            <div class="col-12 d-flex align-items-center justify-content-between">
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb breadcrumb-custom">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><span>Data Klasifikasi Fungsi Jembatan</span></li>
                      </ol>
                    </nav>
          ...
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Tabel Data Klasifikasi Fungsi Jembatan</h4>
              <div class="row">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Jenis Klasifikasi</label>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Jenis Klasifikasi</label>
                              <input type="text" class="form-control" id="recipient-name" value="isi klasifikasi">
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Keterangan</label>
