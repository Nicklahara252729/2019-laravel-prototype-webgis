...
<div class="content-wrapper">
          <div class="row mb-4">
            <div class="col-12 d-flex align-items-center justify-content-between">
              <h4 class="page-title">Data Administrasi Jalan</h4>
            ...
            <div class="col-12 d-flex align-items-center justify-content-between">
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb breadcrumb-custom">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><span>Data Administrasi Jalan</span></li>
                      </ol>
                    </nav>
          ...
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Tabel Data Administrasi Jalan</h4>
              <div class="row">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Administrasi Jalan</label>
                  ...
                  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-2" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Administrasi Jalan</label>
                              <input type="text" class="form-control" id="recipient-name" value="isi adminstrasi jalan">
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Keterangan</label>
