...
<div class="content-wrapper">
          <div class="row mb-4">
            <div class="col-12 d-flex align-items-center justify-content-between">
              <h4 class="page-title">Data Sumber Dana</h4>
            ...
            <div class="col-12 d-flex align-items-center justify-content-between">
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb breadcrumb-custom">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><span>Data Sumber Dana</span></li>
                      </ol>
                    </nav>
          ...
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Tabel Data Sumber Dana</h4>
              <div class="row">
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Dari</label>
                              <input type="text" class="form-control" id="recipient-name" value="Pemerintah">
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Nominal</label>
                              <input type="text" class="form-control" id="recipient-name" value="Rp. 100.000.000">
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Kegunaan</label>
                              <input type="text" class="form-control" id="recipient-name" value="Pembelian Pupuk">
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Keterangan</label>
                              <textarea class="form-control">Keterangab pembelian</textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
