...
<div class="content-wrapper">
          <div class="row mb-4">
            <div class="col-12 d-flex align-items-center justify-content-between">
              <h4 class="page-title">Laporan Infrastruktur Air</h4>
            </div>
          </div>
            ...
            <div class="col-12 d-flex align-items-center justify-content-between">
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb breadcrumb-custom">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><span>Laporan Infrastruktur Air</span></li>
                      </ol>
                    </nav>
          ...
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Laporan Infrastruktur Air</h4>
              <div class="row">
